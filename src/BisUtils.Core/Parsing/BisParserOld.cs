...
public interface IBisParserOld<TAstNode, in TLexer, TTypes> where TLexer : BisLexerOld<TTypes> where TTypes : Enum
{
    /// <summary>
...
public interface IBisParserOld<TAstNode, in TLexer, TTypes, in TPreprocessor> : IBisParserOld<TAstNode, TLexer, TTypes> where TLexer : BisLexerOld<TTypes> where TPreprocessor : BisPreProcessorBase, new() where TTypes : Enum
{
    /// <summary>
